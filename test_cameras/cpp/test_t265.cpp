...
int main()
{
  ...
  while (true) {
    ...
    cv::Mat fisheye_image1(
      cv::Size(848, 800), CV_8U, (void *)fisheye_frame1.get_data(), cv::Mat::AUTO_STEP);
    cv::Mat fisheye_image2(
      cv::Size(848, 800), CV_8U, (void *)fisheye_frame2.get_data(), cv::Mat::AUTO_STEP);
